...
// under both this build's AGP 8.5.2 and android/HopDemo's AGP 9.2.1) and applies to every variant, same
// as the old "main" source set did.
androidComponents {
    onVariants { variant ->
        variant.sources.java?.addStaticSourceDirectory("../../../android/HopDemo/generated/kotlin")
        variant.sources.jniLibs?.addStaticSourceDirectory("../../../android/HopDemo/generated/jniLibs")
    }
}
...
dependencies {
    ...
    // with the app's compose-bom (below in android/HopDemo/app) since both land in the same final APK's
    ...
    // android/HopDemo's (AGP 9.2.1) - so bumping core-ktx here would require also bumping this build's
